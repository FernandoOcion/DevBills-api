...
const createTransactionObject = z.object(
	createTransactionsSchema,
);
export type CreateTransactionDTO = z.infer<
	typeof createTransactionObject
>;
...
const indexTransactionsObject = z.object(
	indexTransactionsSchema,
);
export type IndexTransactionsDTO = z.infer<
	typeof indexTransactionsObject
>;
...
const getDashboardObject = z.object(
	getDashboardSchema,
);
export type GetDashboardDTO = z.infer<
	typeof getDashboardObject
>;
...
const getFinancialEvolutionObject = z.object(
